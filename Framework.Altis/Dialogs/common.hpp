...
class RscText {
	...
	font = "PuristaBold";
	//SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	sizeEx = "0.019 / (getResolution select 5)";//0.013  
	text = "";
	colorText[] = {1, 1, 1, 1.0};
...
class RscStructuredText {
	...
	w = 0.1;
	text = "";
	size = "0.019 / (getResolution select 5)";//0.013  
	colorText[] = {1, 1, 1, 1.0};
	shadow = 1;
	colorBorder[] = {1,1,1,1};
	borderSize = 1;
...
/*class RscButton 
{
	...
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {1,1,1,1.0};
	colorDisabled[] = {0,0.4,0.81,1};
	colorBackground[] = {0,0.4,0.81,1};
	colorBackgroundActive[] = {0,0.4,0.81,1};
	colorBackgroundDisabled[] = {0,0.4,0.81,1};
	offsetX = 0.003;
	offsetY = 0.003;
	offsetPressedX = 0.002;
	offsetPressedY = 0.002;
	colorFocused[] = {0,0.4,0.81,1};
	colorShadow[] = {0,0,0,1};
	colorBorder[] = {0,0,0,1};
	borderSize = 0.0;
